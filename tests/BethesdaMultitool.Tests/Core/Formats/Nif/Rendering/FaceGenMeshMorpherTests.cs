...
public sealed class FaceGenMeshMorpherTests
{
    ...
    public void WeldSeamNormals_TwoColocatedVerticesSameHemisphere_AveragesNormals()
    {
        ...
        var positions = new[] { 0f, 0f, 0f, 0f, 0f, 0f };
        var normals = new[] { 0.1f, 0.9f, 0f, 0f, 0.9f, 0.1f };
        ...
        Assert.Equal(normals[0], normals[3], 5);
        Assert.Equal(normals[1], normals[4], 5);
        Assert.Equal(normals[2], normals[5], 5);
    ...
    public void RecalculateNormals_DegenerateAccumulation_FallsBackToAuthoredOriginal()
    {
        ...
        Assert.Equal(1f, v0Len, 5);
        Assert.Equal(0f, sub.Normals[0], 5);
        Assert.Equal(0f, sub.Normals[1], 5);
        Assert.Equal(1f, sub.Normals[2], 5);
    }
    ...
    public void WeldSeamNormals_OpposingHemisphereSeam_PreservesSplit()
    {
        ...
        var positions = new[] { 0f, 0f, 0f, 0f, 0f, 0f };
        var normals = new[] { 0f, 0f, 1f, 0f, 0f, -1f };
        ...
        Assert.Equal(1f, len0, 5);
        Assert.Equal(1f, len1, 5);
        Assert.Equal(1f, normals[2], 5);
        Assert.Equal(-1f, normals[5], 5);
    }
    ...
    public void WeldSeamNormals_ThreeColocatedMixedHemispheres_PartitionsIntoTwoGroups()
    {
        ...
        var positions = new[] { 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f };
        var normals = new[]
        {
            0f, 0f, 1f, // outward A
        ...
        Assert.Equal(-1f, normals[8], 5);
    }

    [Fact]
    public void WeldSeamNormals_NonColocatedVertices_LeftUnchanged()
    {
        var positions = new[] { 0f, 0f, 0f, 10f, 10f, 10f };
        var normals = new[] { 1f, 0f, 0f, 0f, 1f, 0f };
    ...
    public void WeldSeamNormals_ColocatedVerticesAcrossBucketBoundary_StillWeld()
    {
        ...
        var positions = new[] { 0.00995f, 0f, 0f, 0.01005f, 0f, 0f };
        var normals = new[] { 0.7071f, 0f, 0.7071f, 0f, 0.7071f, 0.7071f };

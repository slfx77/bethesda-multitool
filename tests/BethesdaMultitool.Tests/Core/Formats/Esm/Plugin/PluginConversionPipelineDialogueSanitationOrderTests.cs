...
public sealed class PluginConversionPipelineDialogueSanitationOrderTests
{
    [Fact]
    public void CapturedInfoDeduplicationPrecedesQuestVariableSanitationAndRunsOnce()
    {
        ...
        Assert.True(deduplicateIndex >= 0, "PluginConversionPipeline must deduplicate captured INFO records.");

...
/// </summary>
public sealed class BtdVtexGridTests
{
    ...
    public void AssembleVtexGrid_PlacesEachQuadrantInItsCorner()
    {
        ...
        var grid = BtdTerrainInjector.AssembleVtexGrid([10u, 20u, 30u, 40u]);
    ...
    {
        var grid = BtdTerrainInjector.AssembleVtexGrid([7u, 7u, 7u, 7u]);

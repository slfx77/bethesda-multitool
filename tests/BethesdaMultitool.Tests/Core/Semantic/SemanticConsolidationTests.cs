...
public sealed class SemanticConsolidationTests(SampleFileFixture samples) : IDisposable
{
    ...
    public void Structural_guard_limits_manual_semantic_parser_sites_to_allowlist()
    {
        ...
        var sourceRoot = Path.Combine(repoRoot, "src", "BethesdaMultitool");
        var allowedFiles = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            Path.Combine("src", "BethesdaMultitool", "Core", "Semantic", "SemanticFileLoader.cs"),
            Path.Combine("src", "BethesdaMultitool", "CLI", "Commands", "Analysis", "AnalyzeCommand.cs"),
            Path.Combine("src", "BethesdaMultitool", "CLI", "Commands", "Dialogue", "DialogueProvenanceCommand.cs"),
            Path.Combine("src", "BethesdaMultitool", "CLI", "Commands", "Esm", "EsmCellCommand.cs"),
            Path.Combine("src", "BethesdaMultitool", "CLI", "Commands", "Esm", "EsmCommand.cs"),
            Path.Combine("src", "BethesdaMultitool", "Core", "Minidump", "MinidumpExtractionReporter.cs")
        };

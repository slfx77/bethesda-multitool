...
// Copied from src/BethesdaMultitool/Core/FileFormat/SignatureMatcher.cs (this tool is
// deliberately standalone — no ProjectReference). Unlike the old AhoCorasick class this
// keeps a LIST of outputs per node (identical patterns under different names all report)
// and merges outputs across failure links (suffix-overlapping patterns all report).

...
{
    /// <summary>
    ///     Merges the opt-in-enabled gap candidates into <paramref name="scanResult" /> as raw records, runtime dialogue,
    ///     or placed refs, skipping duplicates, and returns promotion counts.
    /// </summary>

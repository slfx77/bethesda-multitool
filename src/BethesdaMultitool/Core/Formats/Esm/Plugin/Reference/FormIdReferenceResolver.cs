...
internal static class FormIdReferenceResolver
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             The original value when <paramref name="formId" /> is 0 or
    ///             <paramref name="validFormIds" /> is null (backward-compat path).
    ///         </item>
    ///         <item>
    ///             The remapped value when the alias table has an entry pointing at a
    ///             valid target.
    ///         </item>
    ///         <item>The original value when it's already in the validity set.</item>
    ///         <item>
    ///             <c>null</c> when the FormID is dangling and has no remap — callers
    ///             should skip emitting the optional subrecord.
    ///         </item>
    ///     </list>
    /// </summary>

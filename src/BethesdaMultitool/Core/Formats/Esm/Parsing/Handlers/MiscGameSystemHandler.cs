...
{
    private readonly NavMeshHandler _navMeshes = new(context);
    ...
    #region Navigation Meshes (delegated to NavMeshHandler)
    ...
    {
        return _navMeshes.ParseNavMeshes();
    }
    ...
    {
        return _navMeshes.ParseNavMeshInfoMaps();
    }

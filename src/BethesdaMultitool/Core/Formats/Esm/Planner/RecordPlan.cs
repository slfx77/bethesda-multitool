...
public sealed record RecordPlan
{
    ...
    /// <summary>
    ///     True when the reparent target is a PLUGIN-NEW worldspace's container (a worldspace
    ///     the master authored no cells for — TheStripWorld, CampMcCarranWorld, …). For these,

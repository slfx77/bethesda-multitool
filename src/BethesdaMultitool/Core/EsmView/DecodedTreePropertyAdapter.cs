...
///     schema-driven parser — Oblivion, Skyrim, FO4, and FO76) into the
///     <see cref="EsmPropertyEntry" /> rows the detail panel renders. Member order is preserved (the
///     schema's order is the meaningful one), struct/array

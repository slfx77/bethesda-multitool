...
public sealed partial class FalloutApp : Application
{
    ...
    public FalloutApp()
    {
        ...
        Console.WriteLine("[BethesdaMultitool] Application starting...");
        ...
        try
        {
            ...
            InitializeComponent();
            Console.WriteLine("[BethesdaMultitool] App initialized");
        }
        catch (Exception ex)
        {
    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        try
        {
            Console.WriteLine("[BethesdaMultitool] Creating main window...");
            MainWindow = LaunchWindowFactory?.Invoke() ?? new MainWindow();
            Console.WriteLine("[BethesdaMultitool] Activating main window...");
            MainWindow.Activate();
            Console.WriteLine("[BethesdaMultitool] Main window activated");
        }
        catch (Exception ex)
        {

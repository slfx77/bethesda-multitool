...
///     <see cref="GameProfile.MarkerArt" /> strategy. Embedded games (FO3/FNV/FO4 tinted;
///     Oblivion/Skyrim/FO76 pre-styled) share the catalog-driven <see cref="EmbeddedMarkerIconSet" />;
///     the rest are glyph-only until their icons are extracted + wired.
/// </summary>

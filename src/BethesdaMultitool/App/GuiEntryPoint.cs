...
public static class GuiEntryPoint
{
    ...
    ///     BethesdaMap2DProfiler's logger setup. Also auto-enables the 2D-map cache/viewport/stream trace
    ...
    ///     GUI log file (<c>%TEMP%\BethesdaMultitool-gui.log</c>) so the cause survives a crash —
